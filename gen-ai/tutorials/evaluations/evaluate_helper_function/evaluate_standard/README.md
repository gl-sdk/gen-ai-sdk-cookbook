# Standard Dataset Evaluation Tutorial

This tutorial demonstrates how to use the **`evaluate_suites()`** function with standard datasets in the GenAI Evaluator SDK.
...
Run the standard dataset evaluation example:
...
make run        # Run the standard dataset evaluation script

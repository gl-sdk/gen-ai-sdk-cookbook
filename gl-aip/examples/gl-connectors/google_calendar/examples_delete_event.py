...
DESIRED_TOOLS = {"google_calendar_events_delete", "google_calendar_calendarlist_get", "google_calendar_events_list"}
...
async def main():
    ...
    prompt = (
        f"Delete the '{EVENT_NAME}' event on {EVENT_DATE} at {EVENT_TIME}."
    )
